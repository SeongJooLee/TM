				...
				<form id="frm" action="addDone" method="post"
					...
					<div class="row">
						...
						<div class="col-md-6 mb-3 font2">
							<label for="title">글 제목</label> <input type="text"
								class="form-control" name="title" id="title" placeholder="제목 입력해주세요." >
						</div>
					</div>
					<div class="mb-3 font2">
						<label for="image">이미지 파일 첨부</label> <input type="button"
							...
							placeholder="" value="파일 추가"><small class="font3">*최대 3개까지 첨부
							가능합니다.</small>
						<div id="d_file"></div>
					</div>
					<div class="mb-3 font2">
