	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<button class="btn btn-primary btn-lg btn-block" onclick='updateUser()'>수정 하기</button>
				<button class="btn btn-primary btn-lg btn-block" onclick='deleteUser()'>삭제 작성</button>
