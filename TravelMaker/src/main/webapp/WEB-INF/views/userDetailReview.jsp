	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<br> <br>
				<h4 class="mb-3" align="center">이용후기 상세보기</h4>
				<br> <br>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.reviewNO}</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.title}</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.content}</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.writeDate}</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.id}</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label class='form-control'>${review.promotionNO}</label>
					</div>
				</div>
				
				<div class="row">
					<div class="col-md-6 mb-3">
						<label class='form-control'>게시판종류</label>
					</div>
					<div class="col-md-6 mb-3">
